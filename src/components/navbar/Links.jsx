    ...
    <React.Fragment>
        {links.map((obj)=>(
            ...
            <React.Fragment key={obj.key}>
                <li><Link to={obj.link} className='link'>{obj.title}</Link></li>
            </React.Fragment>
            :
            <React.Fragment key={obj.key}>
                <li><h1 className="link">{obj.title}<i className='bx bx-chevron-down' ></i></h1>
                    ...
                    {obj.links.map((obj2)=>(
                        ...
                        <React.Fragment key={obj2.key}>
                            <li><Link to={obj2.link} className="link">{obj2.title}</Link></li>
                        </React.Fragment>
                        :
                        <React.Fragment key={obj2.key}>
                            <li><h1 className='link'>{obj2.title}<i className='bx bx-chevron-down' ></i></h1>
                                ...
                                {obj2.links.map((obj3)=>(
                                    ...
                                    <React.Fragment key={obj3.key}>
                                        <li><Link to={obj3.link} className="link">{obj3.title}</Link></li>
                                    </React.Fragment>
                                    :
                                    <React.Fragment key={obj3.key}>
                                        <li><h1 className='link'>{obj3.title}<i className='bx bx-chevron-down' ></i></h1>
                                            ...
                                            {obj3.links.map((obj4)=>(
                                                ...
                                                <React.Fragment key={obj4.key}>
                                                    <li><Link to={obj4.link} className="link">{obj4.title}</Link></li>
                                                </React.Fragment>
                                                :
                                                <React.Fragment key={obj4.key}>
